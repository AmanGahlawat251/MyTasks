...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
	...
	if (isset($_POST['purpose']) && ($_POST['purpose'] == '3 Year' || $_POST['purpose'] == '4 Year')) {
	...
	$con = "education_type ='".$education_type."' AND qualification = '".$qualification."' AND $exam = '".$overall_score."' AND gpa >= '".$min_gpa."' AND gpa <= '".$max_gpa."' ";
        ...
        <div class="row justify-content-center align-self-center">
          <div class="col-xs-12 col-sm-12 col-md-12 col-lg-8 push-lg-2">
            <div class="dc-sectionhead dc-text-center">
              <div class="dc-sectiontitle mt-4">
          ...
          <div class="dc-loginformholds">
            ...
            <form class="dc-formtheme dc-loginform do-login-form">
              <fieldset>
                ...
                <div class="form-group">
                  <input type="text" name="phone" class="form-control removeChars" data-regex="[^0-9+]" maxlength="13" placeholder="Mobile number">
                </div>
                <div class="dc-logininfo" style="text-align:center;">
                  <input type="submit" class="dc-btn do-login-button" data-id="0" value="See More">
                </div>
              </fieldset>
            </form>
          </div>
