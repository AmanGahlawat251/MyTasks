...
<head>
  ...
  <title>Sale Return | <?php echo LOGO_ALT; ?> </title>
  <style>.tooltip-inner {
   width: 350px;
}
  ...
  <link rel="stylesheet" href="plugins/select2-bootstrap4-theme/select2-bootstrap4.min.css">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Sale Return</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
	 ...
	 <section class="content">
      <div class="container-fluid">
		...
		<div id="div_order" class="col-12">
          ...
          <?php 
		  echo $mysqli->view_sale_details($order_id,"SALE_RETURN");
		  ?>
		   	<input type='hidden' name='temp_order_id' id='temp_order_id' value="<?php echo $order_id;  ?>" />
		</div>
		</div>
	</div>
	</section>
