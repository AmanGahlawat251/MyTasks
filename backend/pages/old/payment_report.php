...
.select2-container--default .select2-selection--single 
{
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-9">
            <h1 class="m-0 text-dark">Payment Report</h1></br>
          </div><!-- /.col -->
            ...
            <div  class="card card-info">
              ...
              <!-- form start -->
				<form onsubmit="return false;" id="frm_search" method="post" >
					...
					<!-- /.card-body -->
					<input type='hidden' name='tab' value="<?php echo 'payment_report'; ?>" />					
					<input type="hidden" name="url" id="url" value="<?php echo "index.php?".$mysqli->encode("stat=table_response"); ?>" required>			  
					<input type="hidden" name="record_limit" id="record_limit" value="20"> 			
