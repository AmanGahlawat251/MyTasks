...
.text-left {
      ...
      <div class="container-fluid">
        <div class="row">
         ...
         <form onsubmit="return false;" id="frm_search" method="post" >
					...
					<input type='hidden' name='tab' value="<?php echo 'view_edu_config'; ?>" />					
            ...
            <div class="card card-info">
              <div class="card-header">
				...
				<h3 class="card-title">Education Configurations&nbsp; &nbsp;<label id="lbl_total"></label> &nbsp; &nbsp;   <button id="btn_add_lead" style="margin-top: 0px;" type="button" class="btn btn-default btn-xs" data-type="" data-toggle="modal" data-target="#modal-add-educonfig">
                    <i class="fas fa-book-medical icon-2x" aria-hidden="true"  title="Add new "> Add Education Config </i>
                  </button>  </h3>
	...
	<div data-keyboard = "false" data-backdrop = "static" class="modal fade modal_close" id="modal-add-educonfig">
          <div class="modal-dialog modal-xs">			
            <div class="modal-content">
			<form onsubmit="return false;" id="frm_add_educonfig" method="post" >
              <div class="modal-header">
                <h5 class="modal-title" id="m-title"><i class="fa fa-book-medical icon-lg" aria-hidden="true" id="" title="Add new"></i> &nbsp; Add Education Config</h5>
            ...
            <!-- general form elements -->
							<div class="col-md-12">
							  <div class="form-group">
								...
								<input type="text"  class="form-control"  autofocus  name="name" id="name" required />								
							  </div>
							</div>
							
							
					<input type='hidden' name='tab' value="<?php echo 'add_educonfig'; ?>" />
